<div class="guest_book">
	...
	<div class="message_list" id="message_list_<?=$context?>">
		...
		<div class="message_block">
			<div class="message_header"><?=$message['name']?> <?=(($user['rights']=='admin')?$message['email']:"")?></div>
	...
	<div class="message_enter_block">
		...
		<div class="controls_block">
			...
			<div class="field" id="guest_email_field">EMail: <input type="text" size=25; value="" id="guest_email_input" /></div>
			<div class="field" id="message_send_field">
				<div class="button" id="send_button" onclick="sendMessage(<?=$context?>)">Send</div> 
